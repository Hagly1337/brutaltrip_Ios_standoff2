...
static monoString *il2cpp_string_new(const char *str) {
    static monoString *(*String_CreateString)(void *instance, const char *str, int start, int len) = (monoString *(*)(void *, const char *, int, int)) getRealOffset(oxorany(0x2766908));
